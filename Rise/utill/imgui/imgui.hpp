...
// Configuration file with compile-time options (edit imconfig.h or '#define IMGUI_USER_CONFIG "myfilename.hpp" from your build system')
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_WindowDecoration = ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoCollapse,
...
#define IM_COL32_BLUE       IM_COL32(52, 91, 235,255)  // Opaque white = 0xFFFFFFFF
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddTextR(const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL);
    IMGUI_API void  AddTextR(const ImFont* font, float font_size, const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL, float wrap_width = 0.0f, const ImVec4* cpu_fine_clip_rect = NULL);
